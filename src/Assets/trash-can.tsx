...
export const TrashCanIcon: React.FC<TrashCanIconProps> = ({onClick, width, height}) => {
    const clicked = () => {
        if (onClick) {
            onClick();
        }
